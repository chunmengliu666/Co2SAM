...
def main(cfg, args):
    ...
    full_checkpoint = fabric.load('output/PascalVOC/save/last-ckpt.pth')
    ...
    validate(fabric, cfg, args, model, dino_model1, val_data, name=cfg.name, epoch=0)
    # validate(fabric, cfg, args, model, dino_model1, train_data, name=cfg.name, epoch=0)
